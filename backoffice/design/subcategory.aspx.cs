...
public partial class backoffice_design_subcategory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Convert.ToInt32(Request.QueryString["psubcatid"]) > 0)
            {
                ...
                clsm.MoveRecord_Parameter(this, psubcatid.Parent, "select * from designsubcate where psubcatid=@psubcatid", Parameters);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            CKeditor2.ReadOnly = true;
            if (Convert.ToInt32(clsm.MasterSave(this, psubcatid.Parent, 19, mainclass.Mode.modeCheckDuplicate, "designsubcateSP", Convert.ToString(Session["UserId"]))) > 0)
            {
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
            ...
            if (string.IsNullOrEmpty(psubcatid.Text))
            {
                ...
                CKeditor2.ReadOnly = true;
                Status.Checked = true;
                string var = clsm.MasterSave(this, psubcatid.Parent, 19, mainclass.Mode.modeAdd, "designsubcateSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                if (!string.IsNullOrEmpty(File2.PostedFile.FileName))
                {
                    ...
                    StrFileName = Convert.ToString(clsm.SendValue_Parameter("Select banner from designsubcate where psubcatid=@psubcatid", Parameters));
            ...
            else
            {
                ...
                CKeditor1.ReadOnly = true;
                CKeditor2.ReadOnly = true;
                string var = clsm.MasterSave(this, psubcatid.Parent, 19, mainclass.Mode.modeModify, "designsubcateSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                if (!string.IsNullOrEmpty(File2.PostedFile.FileName))
                {
                    banner.Text = HttpUtility.HtmlEncode(Path.GetFileName(var + "sdscimg_" + Path.GetFileName(File2.PostedFile.FileName.Replace(" ", "")).Replace("&", "")));
                    ...
                    objcon.Open();
                    SqlCommand objcmd = new SqlCommand("update designsubcate set banner=@banner where psubcatid=" + var + "", objcon);
                ...
                if (!string.IsNullOrEmpty(File1.PostedFile.FileName))
                {
                    ...
                    UploadAImage.Text = HttpUtility.HtmlEncode(Path.GetFileName(var + "sdscpd_" + Path.GetFileName(File1.PostedFile.FileName.Replace(" ", "")).Replace("&", "")));
                    ...
                    SqlConnection objcon = new SqlConnection(clsm.strconnect);
                    objcon.Open();
                    SqlCommand objcmd = new SqlCommand("update designsubcate set UploadAImage=@UploadAImage where psubcatid=" + var + "", objcon);
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@psubcatid", Convert.ToInt32(Request.QueryString["psubcatid"]));
        clsm.SendValue_Parameter("update designsubcate set banner='' where psubcatid=@psubcatid", Parameters);
        banner.Text = "";
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@psubcatid", Convert.ToInt32(Request.QueryString["psubcatid"]));
        clsm.SendValue_Parameter("update designsubcate set UploadAImage='' where psubcatid=@psubcatid", Parameters);
        UploadAImage.Text = "";
        Image1.Visible = false;
        trsuccess.Visible = true;

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mapevents.aspx.cs" Inherits="backoffice_gallery_mapevents" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2" width="80%">
                    ...
                    <tr>
                        <td align="right" style="width: 15%" valign="top">
                            Events: <span class="star">*</span> :&nbsp;
                        </td>
                        <asp:Panel ID="panelChk" runat="server">
                            <td align="left" style="width: 85%">
                                <asp:DataList ID="eventslist" runat="server" RepeatDirection="Horizontal" RepeatColumns="2">
                                    <ItemTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="90%" align="left">
                                                    <asp:CheckBox ID="checkfeature" runat="server" />
                                                    <asp:Label ID="lbleventstitle" runat="server" Text='<%#Eval("eventstitle")%>'
                                                        Visible="true"></asp:Label>
                                                   
                                                    <asp:Label ID="lbleventsid" runat="server" Text='<%#Eval("eventsid")%>'

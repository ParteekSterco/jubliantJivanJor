<%@ Page Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true"
    CodeFile="product.aspx.cs" Inherits="backoffice_Products_product" Theme="backtheme" %>
            ...
            <tr>
                ...
                <td width="85%">
                    <asp:DropDownList ID="psubcatid" runat="server" Width="200px">
                       ...
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="psubcatid"
       Display="Dynamic" ErrorMessage="Required" InitialValue="0"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td valign="top" width="15%" align="right">
                    Application Area<span class="star"></span> : &nbsp;
                </td>
                <td width="85%">
            ...
            <tr>
                ...
                <td>
                    <CKEditor:CKEditorControl ID="CKeditor2" runat="server" Height="150" BasePath="~/ckeditor">
                    </CKEditor:CKEditorControl>
            ...
            <tr>
                ...
                <td>
                    <CKEditor:CKEditorControl ID="CKeditor6" runat="server" Height="150" BasePath="~/ckeditor">
                    </CKEditor:CKEditorControl>
                    <asp:TextBox ID="appdetail" runat="server" Visible="False" Width="122px"></asp:TextBox>
                </td>
            </tr>

             <tr >
                <td valign="top" align="right">
                    Pack  Size<span class="star"></span> : &nbsp;
                </td>
                <td>
                 <CKEditor:CKEditorControl ID="CKeditor4" runat="server" Height="150" BasePath="~/ckeditor">
                 </CKEditor:CKEditorControl>
                    <asp:TextBox ID="producttitle" runat="server" Width="350px" Visible="False"></asp:TextBox>
                </td>
            </tr>
             ...
             <tr >
                ...
                <td>
                    <CKEditor:CKEditorControl ID="CKeditor3" runat="server" Height="150" BasePath="~/ckeditor">
                    </CKEditor:CKEditorControl>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <br />
                    <asp:Label ID="Label4" runat="server"  ForeColor="red" Font-Italic="true" Visible="false"></asp:Label>
            ...
            <tr >
              ...
              <tr >
                <td align="right">
                    Video Image<span class="star"></span> :&nbsp;
                </td>
                <td align="left">
                    <input id="File5" runat="server" class="box" contenteditable="false" onchange="showpreview(this);"
                        type="file" />&nbsp;<asp:Label ID="Label5" runat="server" Text="(Image should be of size : 387x351.)"
                            ForeColor="red" Font-Italic="true" Visible="false"></asp:Label>
                    <br />
                    <asp:LinkButton ID="LinkButton4" runat="server" CssClass="toptxt" Visible="false"
                        OnClick="LinkButton5_Click">Remove File</asp:LinkButton>
                    <asp:TextBox ID="videoimage" runat="server" Visible="False" Width="122px">
            ...
            <tr >
                ...
                <td>
                    <CKEditor:CKEditorControl ID="CKeditor7" runat="server" Height="150" BasePath="~/ckeditor">
                    </CKEditor:CKEditorControl>
                    <asp:TextBox ID="appvideodetail" runat="server" Visible="False" Width="122px"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr >
                ...
                <td align="left">
                    <asp:Image ID="Image4" runat="server" Height="120px" Visible="False" Width="107px" />
                </td>
            </tr>
             <tr >
                <td align="right">
                ...
                <td align="left">
                    <input id="File4" runat="server" class="box" contenteditable="false" onchange="showpreview(this);"
                        type="file" />&nbsp;<asp:Label ID="Label3" runat="server" Text="(Image should be of size : 387x351.)"
                            ForeColor="red" Font-Italic="true" Visible="false"></asp:Label>
                    <br />
                    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="toptxt" Visible="false"
                        OnClick="LinkButton3_Click">Remove File</asp:LinkButton>
                    <asp:TextBox ID="producticon" runat="server" Visible="False" Width="122px">
            ...
            <tr >
                ...
                <td align="left">
                    <asp:Image ID="Image3" runat="server" Height="120px" Visible="False" Width="107px" />
                </td>
            </tr>
            <tr  >
                <td align="right" valign="top">
            ...
            <tr style="display: none;">
             ...
             <tr>
                <td align="right" valign="top">Youtube URL
                </td>
                <td align="left">

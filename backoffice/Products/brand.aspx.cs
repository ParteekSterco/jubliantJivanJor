...
public partial class backoffice_Products_brand : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Convert.ToInt32(Request.QueryString["pcatid"]) > 0)
            {
                ...
                clsm.MoveRecord_Parameter(this, pcatid.Parent, "select * from brand where pcatid=@pcatid", Parameters);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            CKeditor3.ReadOnly = true;
            if (Convert.ToInt32(clsm.MasterSave(this, pcatid.Parent, 19, mainclass.Mode.modeCheckDuplicate, "brandSP", Convert.ToString(Session["UserId"]))) > 0)
            {
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
            ...
            if (string.IsNullOrEmpty(pcatid.Text))
            {
                ...
                CKeditor3.ReadOnly = true;
                Status.Checked = true;
                string var = clsm.MasterSave(this, pcatid.Parent, 19, mainclass.Mode.modeAdd, "brandSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
                if (!string.IsNullOrEmpty(File2.PostedFile.FileName))
                {
                    ...
                    StrFileName = Convert.ToString(clsm.SendValue_Parameter("Select banner from productcate where pcatid=@pcatid", Parameters));
            ...
            else
            {
                ...
                CKeditor2.ReadOnly = true;
                CKeditor3.ReadOnly = true;
                string var = clsm.MasterSave(this, pcatid.Parent, 19, mainclass.Mode.modeModify, "brandSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
                if (!string.IsNullOrEmpty(File1.PostedFile.FileName))
                {
                    ...
                    UploadAPDF.Text = HttpUtility.HtmlEncode(Path.GetFileName(var + "bpd_" + Path.GetFileName(File1.PostedFile.FileName.Replace(" ", "")).Replace("&", "")));
                   // UploadAPDF.Text = HttpUtility.HtmlEncode(Path.GetFileName(Path.GetFileName(File1.PostedFile.FileName.Replace(" ", "")).Replace("&", "")));
                    ...
                    objcon.Open();
                    SqlCommand objcmd = new SqlCommand("update brand set UploadAPDF=@UploadAPDF where pcatid=" + Convert.ToInt32(var) + "", objcon);
                ...
                if (!string.IsNullOrEmpty(File2.PostedFile.FileName))
                {
                    ...
                    SqlConnection objcon = new SqlConnection(clsm.strconnect);
                    objcon.Open();
                    SqlCommand objcmd = new SqlCommand("update brand set banner=@banner where pcatid=" + var + "", objcon);
                ...
                if (!string.IsNullOrEmpty(File3.PostedFile.FileName))
                {
                    ...
                    SqlConnection objcon = new SqlConnection(clsm.strconnect);
                    objcon.Open();
                    SqlCommand objcmd = new SqlCommand("update brand set homeimage=@homeimage where pcatid=" + var + "", objcon);
                ...
                Response.Redirect("viewbrand.aspx?edit=edit");
            }
        }
        catch (Exception ex)
        {
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@pcatid", Convert.ToInt32(Request.QueryString["pcatid"]));
        clsm.SendValue_Parameter("update brand set banner='' where pcatid=@pcatid", Parameters);
        banner.Text = "";
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@pcatid", Convert.ToInt32(Request.QueryString["pcatid"]));
        clsm.SendValue_Parameter("update brand set UploadAPDF='' where pcatid=@pcatid", Parameters);
        banner.Text = "";
        Image1.Visible = false;
        trsuccess.Visible = true;
        LinkButton1.Visible = false;
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@pcatid", Convert.ToInt32(Request.QueryString["pcatid"]));
        clsm.SendValue_Parameter("update brand set homeimage='' where pcatid=@pcatid", Parameters);
        homeimage.Text = "";

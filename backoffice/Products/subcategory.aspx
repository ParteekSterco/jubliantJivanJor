<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    AutoEventWireup="true" CodeFile="subcategory.aspx.cs" Inherits="backoffice_Products_subcategory"
    Theme="backtheme" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<h2>Add/Edit Sub Category</h2>
    ...
    <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:CheckBox ID="showonsanden" runat="server" Visible="False" Checked="true" />
        ...
        <tr >
            ...
            <td align="left" style="width: 85%; height: 26px;">
                <asp:DropDownList ID="pcatid" runat="server" Width="250px">
                </asp:DropDownList>
        ...
        <tr style="display:none">
            <td align="right" style="width: 15%; height: 26px;">
                Single/Double<span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%; height: 26px;">
                 <asp:DropDownList ID="showsingle" runat="server" Width="250px">
        ...
        <tr >
            ...
            <td align="left">
                <asp:TextBox ID="PageMeta" runat="server" Visible="true" Width="500" Height="100" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr >
            <td align="right" style="width: 15%; height: 26px;" valign="top">
            ...
            <td align="left">
                <asp:TextBox ID="PageMetaDesc" runat="server" Visible="true" Width="500" Height="100" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr >

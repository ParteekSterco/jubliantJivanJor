<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mapproductapplication.aspx.cs" Inherits="backoffice_Products_mapproductapplication" Theme="backtheme" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="90%" align="left">
                                                    ...
                                                    <asp:Label ID="lblcampusname" runat="server" Text='<%#Eval("brand")%>'
                                                        Visible="true"></asp:Label>
                                                   
                                                    <asp:Label ID="lblcampusid" runat="server" Text='<%#Eval("pcatid")%>'

<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    AutoEventWireup="true" CodeFile="brandnew.aspx.cs" Inherits="backoffice_Products_brandnew"
    Theme="backtheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-panel">
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                ...
                <td align="left" colspan="2">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            <td class="head1"></td>
                            <td align="right">&nbsp;
                                <asp:TextBox ID="pcatid" runat="server" Visible="False" Width="33px"></asp:TextBox>
            ...
            <tr>
                <td align="right" style="width: 15%; height: 26px;">Category<span class="star">*</span> :&nbsp;
                </td>
                <td align="left" style="width: 85%; height: 26px;">
                    <asp:DropDownList ID="catid" runat="server" Width="250px">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="catid"
                        Display="Dynamic" ErrorMessage="Required" InitialValue="0"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 15%; height: 26px;">Brand<span class="star">*</span> :&nbsp;
                </td>
                <td align="left" style="width: 85%; height: 26px;">
                    <asp:TextBox ID="brand" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                        Width="214px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="brand"
                        Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator>
                </td>
            </tr>           
            <tr style="display: none">
                <td align="right" width="15%" height="26px">Short Detail : &nbsp;
                </td>
            ...
            <tr>
                <td align="right" width="15%" height="26px">Detail : &nbsp;
                </td>
                <td align="left" width="85%" height="26px">
             ...
             <tr>
                <td align="right" width="15%" height="26px">Detail 2 : &nbsp;
                </td>
                <td align="left" width="85%" height="26px">
            ...
            <tr>
                <td align="right">Upload logo<span class="star"></span> :&nbsp;
                </td>
                <td align="left">
            ...
            <tr>
                <td align="right" height="10" style="width: 15%"></td>

<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/popblank.master" AutoEventWireup="true" CodeFile="mapproduct.aspx.cs" Inherits="backoffice_Products_mapproduct" Theme="backtheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
        <tr>
            <td class="head1" colspan="2">Add/Edit Product Banner  &nbsp;
        ...
        <tr>
            <td align="right" style="width: 15%">Detail 1<span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%">
                <CKEditor:CKEditorControl ID="CKeditor2" runat="server" Height="150" BasePath="~/ckeditor">
                </CKEditor:CKEditorControl>
                <asp:TextBox ID="bid" runat="server" Visible="False" Width="122px"></asp:TextBox>
            

            </td>
        </tr>
        <tr style="display: none;">
            <td align="right" style="width: 15%">Model<span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%">
        ...
        <tr style="display: none;">
            <td align="right" style="width: 15%">Size<span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%">
                <asp:DropDownList ID="sizeid" runat="server">
                    <asp:ListItem Value="0"></asp:ListItem>
                </asp:DropDownList>
        ...
        <tr style="display: none;">
            <td align="right" style="width: 15%">Finish<span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%">
                <asp:DropDownList ID="lookid" runat="server">
                    <asp:ListItem Value="0"></asp:ListItem>
                </asp:DropDownList>
        ...
        <tr style="display: none;">
            <td align="right" style="width: 15%">PCD<span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%">
                <asp:DropDownList ID="coatid" runat="server">
                    <asp:ListItem Value="0"></asp:ListItem>
                </asp:DropDownList>
        ...
        <tr style="display: none;">
            <td valign="top" align="right">Price<span class="star"></span> : &nbsp;
            </td>
            <td>

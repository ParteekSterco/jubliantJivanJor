<%@ Page Language="C#" AutoEventWireup="true" CodeFile="maptestimonials.aspx.cs" Theme="backtheme" Inherits="backoffice_Products_maptestimonialscampus" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="90%" align="left">
                                                    ...
                                                    <asp:Label ID="lblcampusname" runat="server" Text='<%#Eval("Testimonialname")%>'
                                                        Visible="true"></asp:Label>
                                                   
                                                    <asp:Label ID="lblcampusid" runat="server" Text='<%#Eval("testimonialid")%>'

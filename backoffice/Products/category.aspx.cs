...
public partial class backoffice_Products_category : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Convert.ToInt32(Request.QueryString["pcatid"]) > 0)
            {
                ...
                clsm.MoveRecord_Parameter(this, pcatid.Parent, "select * from productcate where pcatid=@pcatid", Parameters);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            CKeditor3.ReadOnly = true;
            if (Convert.ToInt32(clsm.MasterSave(this, pcatid.Parent, 18, mainclass.Mode.modeCheckDuplicate, "productcateSP", Convert.ToString(Session["UserId"]))) > 0)
            {
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
            ...
            if (string.IsNullOrEmpty(pcatid.Text))
            {
                ...
                CKeditor3.ReadOnly = true;
                Status.Checked = true;
                string var = clsm.MasterSave(this, pcatid.Parent, 18, mainclass.Mode.modeAdd, "productcateSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
                if (!string.IsNullOrEmpty(File2.PostedFile.FileName))
            ...
            else
            {
                ...
                CKeditor2.ReadOnly = true;
                CKeditor3.ReadOnly = true;
                string var = clsm.MasterSave(this, pcatid.Parent, 18, mainclass.Mode.modeModify, "productcateSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
                if (!string.IsNullOrEmpty(File1.PostedFile.FileName))
                ...
                if (!string.IsNullOrEmpty(File2.PostedFile.FileName))
                {
                    banner.Text = HttpUtility.HtmlEncode(Path.GetFileName(var + "cimg_" + Path.GetFileName(File2.PostedFile.FileName.Replace(" ", "")).Replace("&", "")));
                    ...
                    SqlConnection objcon = new SqlConnection(clsm.strconnect);
                    objcon.Open();
                    SqlCommand objcmd = new SqlCommand("update productcate set banner=@banner where pcatid=" + var + "", objcon);
                ...
                if (!string.IsNullOrEmpty(File3.PostedFile.FileName))
                {
                    homeimage.Text = HttpUtility.HtmlEncode(Path.GetFileName(var + "himg_" + Path.GetFileName(File3.PostedFile.FileName.Replace(" ", "")).Replace("&", "")));
                    ...
                    SqlConnection objcon = new SqlConnection(clsm.strconnect);
                    objcon.Open();
                    SqlCommand objcmd = new SqlCommand("update productcate set homeimage=@homeimage where pcatid=" + var + "", objcon);
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@pcatid", Convert.ToInt32(Request.QueryString["pcatid"]));
        clsm.SendValue_Parameter("update productcate set banner='' where pcatid=@pcatid", Parameters);
        banner.Text = "";
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@pcatid", Convert.ToInt32(Request.QueryString["pcatid"]));
        clsm.SendValue_Parameter("update productcate set UploadAPDF='' where pcatid=@pcatid", Parameters);
        banner.Text = "";
        Image1.Visible = false;
        trsuccess.Visible = true;
        LinkButton1.Visible = false;
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        Parameters.Clear();
        Parameters.Add("@pcatid", Convert.ToInt32(Request.QueryString["pcatid"]));
        clsm.SendValue_Parameter("update productcate set homeimage='' where pcatid=@pcatid", Parameters);
        homeimage.Text = "";

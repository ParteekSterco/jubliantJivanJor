<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    AutoEventWireup="true" CodeFile="brand.aspx.cs" Inherits="backoffice_Products_brand"
    Theme="backtheme" %>
        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td align="right" style="width: 15%; height: 26px;">
                    Application<span class="star">*</span> :&nbsp;
                </td>
            ...
            <tr style="display: none;">
                <td align="right">
                    Application Image<span class="star"></span> :&nbsp;
                </td>
                <td align="left">
            ...
            <tr>
                <td align="right" style="width: 15%; height: 26px;" valign="top">
                    <span class="star"></span>Youtube Url:&nbsp;
                </td>
                <td align="left">

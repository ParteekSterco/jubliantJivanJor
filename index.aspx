        ...
        <div class="d-sm-none d-block bg-white">
            <div class="container">
                <div class="adhesive_mobile">
                    ...
                    <h3>One of the
                        <br>
                        Largest Adhesive Brand in India</h3>
                </div>
            </div>
        </div>
        ...
        <section class="application pt-0">
            ...
            <div class="testimonial-video" data-aos="fade-up">
                <asp:Repeater ID="rptapplication" runat="server">
                    <ItemTemplate>
                        <div class="ïmage-container image-one">
                            <div class="box">
                                ...
                                <div class="box">
                                    <figure>
                                        <a data-fancybox="images" href="/uploads/<%#Eval("uploadvedio")%>">
                                            <img src="/uploads/TestimonialImage/<%#Eval("uploadphoto")%>" alt="testmonial-img" class="image img-fluid">
                                        </a>
                                    </figure>
                                    <div class="test-box">
                                    ...
                                    <div id="panel1" runat="server">
                                        <div>
                                            <a id="ank" runat="server">
                                                <img src="/Uploads/SmallImages/<%#Eval("uploadevents") %>" class="image img-fluid" alt="happening">
                                                <div class="icon">
            ...
            <div class="container-lg">
                <div class="row">
                    <div class="img-box" data-aos="fade-right">
                        <figure>
                            <img alt="certified-img" class="w-100 image" src="/images/certified01.png" />
                        </figure>
                    </div>
